...
int main(int argc, char *argv[])
{
	...
	result = system->setSoftwareFormat(16000, FMOD_SPEAKERMODE_STEREO, 1);
	...
	channel->setVolume(1);   // (5) 볼륨을 높이면 ouput.wav에서 소리가 이상해짐
	channel->setPaused(true);

	//sound initial
	FMOD_VECTOR pos = { DISTANCE * cos(0), 1.0f, DISTANCE * sin(0) };
